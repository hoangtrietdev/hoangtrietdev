...
**Frontend:** React, Next.js, TypeScript, JavaScript, Tailwind CSS, React Query, React Hook Form  
**Backend:** Node.js, NestJS, Express.js, REST APIs, GraphQL, PostgreSQL, MongoDB, DynamoDB  
**Cloud & DevOps:** AWS (Solutions Architect – Associate), Docker, Kubernetes, CI/CD, Serverless, SonarCloud  
**Other:** Playwright, Vitest, EJS, ExcelJS, AI Agents & LLM Prompt Engineering  
...
⭐️ From [Triet Ngo Phu Hoang](https://github.com/hoangtrietdev)  
